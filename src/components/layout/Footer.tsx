...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 mt-auto">
      {/* ── Two large tiles ─────────────────────────────────────────── */}
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5 px-5 md:pl-24 md:pr-10 py-10">
        {/* Card 1 — Projects */}
        <Link
      ...
      {/* ── Legal bar ───────────────────────────────────────────────── */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 px-5 md:pl-24 md:pr-10 pb-8 pt-1">
        {/* Left — copyright */}
        <p className="font-mono text-[10px] tracking-[0.12em] uppercase opacity-60">
          &copy; {new Date().getFullYear()} Kevern Angeles. All rights reserved.
        </p>
        ...
        <nav aria-label="Legal links" className="flex items-center gap-5">
          <Link
            href="/privacy"
            className="font-mono text-[10px] tracking-[0.12em] uppercase opacity-60 hover:opacity-100 transition-opacity"
          >
            Privacy Policy
          </Link>
